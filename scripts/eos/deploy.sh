...
cleos system newaccount eosio bnt2aaacnvrt $USR_PUB --stake-cpu "50 TLOS" --stake-net "10 TLOS" --buy-ram-kbytes 50000 --transfer
cleos system newaccount eosio bnt2aaarelay $USR_PUB --stake-cpu "50 TLOS" --stake-net "10 TLOS" --buy-ram-kbytes 50000 --transfer
cleos system newaccount eosio aaa $USR_PUB --stake-cpu "50 TLOS" --stake-net "10 TLOS" --buy-ram-kbytes 50000 --transfer
